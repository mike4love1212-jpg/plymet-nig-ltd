...
<div class="container flex flex-col items-center justify-center mx-auto  mt-[3rem]">
    <div class="relative form-box bg-gray-200 rounded-xl w-[500px] h-content mx-auto p-8 flex flex-col c justify-center">
        <div class="absolute top-0 left-0 right-0 rounded-xl bg-slate-300 w-full p-2">
            ...
            <h2 class="text-green-600 mb-4 text-center text-2xl">LOGIN</h2>
        </div>
        <form id="form" class="flex py-8 flex-col space-y-3 w-full " action="login_logic.php " method="POST">
            ...
            <p class="text-center text-sm text-black/80 font-bold">Not registered? <a href="register.php" class="decoration-none text-blue-500">Register</a></p>
        </form>
    </div>
